...
import CustomerProfile from '../pages/Customer/CustomerProfile';  // ✅ ADDED
...
import WorkerProfile from '../pages/Worker/WorkerProfile';  // ✅ Import actual file
...
// Add this import at the top with other Customer imports:
import WriteReview from '../pages/Customer/WriteReview';

// Update customer routes section:
...
const router = createBrowserRouter([
  ...
  {
    path: '/customer',
    element: <RequireAuth allowedRoles={['customer']}><CustomerLayout /></RequireAuth>,
    children: [
      ...
      { path: 'review/:jobId', element: <WriteReview /> },  // ✅ ADDED
    ],
  },
  ...
  {
    path: '/worker',
    element: <RequireAuth allowedRoles={['worker']}><WorkerLayout /></RequireAuth>,
    children: [
